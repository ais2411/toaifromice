$(document).ready(function () {
  ...
  function startTimeSalam() {
    ...
    if (hSalam < 4) {
      ucapanSalam = "Selamat Malam Ai!"
      kata1 = "Ndak tidur kemalemaan";
      kata2 = "Semoga mimpi indah<i class='fa fa-heart'></i>";
    } else {
      if (hSalam < 11) {
        ucapanSalam = "Selamat Pagi Aii"
        kata1 = "Jangan lupa sarapan";
        kata2 = "Semoga hari harimu menyenangkan <i class='fa fa-heart'></i>";
      } else {
        if (hSalam < 16) {
          ucapanSalam = "Selamat Siang Aiii"
          kata1 = "Jangan lupa makan siang";
          kata2 = "Jangan lupa minum juga juga<i class='fa fa-heart'></i>";
        } else {
          if (hSalam < 20) {
            ucapanSalam = "Selamat Sore Ais"
            kata1 = "Jangan lupa mandi hahaha";
            kata2 = "Jangan lupa minum juga yaa<i class='fa fa-heart'></i>";
          } else {
              ucapanSalam = "Selamat Malam Aii"
